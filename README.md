...
4. Run the RUNME.ipynb from the virtual environment
    1. If your system has sufficient memory free to hold the similarity matrix (>4GB):
            1. In the "Generating Recommender System Framework" section of RUNME.ipynb, set createSimMatrix to False
            2. In "src/recommendation/views.py", uncomment line 44
            3. In "src/recommendation/views.py", comment line 41
